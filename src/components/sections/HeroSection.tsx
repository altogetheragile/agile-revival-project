...
const HeroSection = () => {
  return (
    <section id="home" className="min-h-screen flex items-center pt-16 bg-gradient-to-br from-white via-white to-agile-purple-light">
        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 md:pr-10 mb-10 md:mb-0 animate-fade-in">
            ...
            <p className="text-lg md:text-xl text-gray-700 mb-8">
              We help teams and organizations embrace agility, improve collaboration, and deliver exceptional value to customers.
            </p>
